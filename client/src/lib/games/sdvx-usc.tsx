...
export const SDVX_IMPL: GPTClientImplementation<"sdvx:Single"> = {
	...
	classColours: {
		dan: {
			...
			DIVINE_DAN_1: bgc(COLOUR_SET.red, "var(--bs-light)"),
			DAN_2: bgc(COLOUR_SET.paleBlue, "var(--bs-light)"),
			DIVINE_DAN_2: bgc(COLOUR_SET.paleBlue, "var(--bs-light)"),
			DAN_3: bgc("gold", "var(--bs-dark)"),
			DIVINE_DAN_3: bgc("gold", "var(--bs-dark)"),
			DAN_4: bgc("gray", "var(--bs-light)"),
			DIVINE_DAN_4: bgc("gray", "var(--bs-light)"),
			DAN_5: bgc(COLOUR_SET.teal, "var(--bs-dark)"),
			DIVINE_DAN_5: bgc(COLOUR_SET.teal, "var(--bs-dark)"),
			DAN_6: bgc("blue", "var(--bs-light)"),
			DIVINE_DAN_6: bgc("blue", "var(--bs-light)"),
			DAN_7: bgc(COLOUR_SET.vibrantPink, "var(--bs-dark)"),
			DIVINE_DAN_7: bgc(COLOUR_SET.vibrantPink, "var(--bs-dark)"),
			DAN_8: bgc("pink", "var(--bs-dark)"),
			DIVINE_DAN_8: bgc("pink", "var(--bs-dark)"),
			DAN_9: bgc("white", "var(--bs-dark)"),
			DIVINE_DAN_9: bgc("white", "var(--bs-dark)"),
			DAN_10: bgc("var(--bs-warning)", "var(--bs-dark)"),
			DIVINE_DAN_10: bgc("var(--bs-warning)", "var(--bs-dark)"),
			DAN_11: bgc("var(--bs-danger)", "var(--bs-light)"),
			DIVINE_DAN_11: bgc("var(--bs-danger)", "var(--bs-light)"),
			INF: bgc("purple", "gold"),
			DIVINE_INF: bgc("purple", "gold"),
		},
		vfClass: {
